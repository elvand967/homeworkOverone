...
# Введите строку, либо число: обороноспособность
# произведение гласных и согласных букв: 77
# coгласные буквы: ['б', 'р', 'н', 'с', 'п', 'с', 'б', 'н', 'с', 'т', 'ь']
# длинна тестируемой строки: 18
# Продолжить работу (Y/N): y
# Введите строку, либо число: 9632587
# произведение суммы чётных цифр ([6, 2, 8] = 16) на длину числа:  112
# длинна тестируемого числа: 7
